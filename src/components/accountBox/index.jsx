          ...
          {active === "signin" && (
            <>
              <HeaderContainer>
                ...
                <HeaderText>Tillbaka</HeaderText>
              </HeaderContainer>
              <SmallText>Logga in med ditt användarnamn!</SmallText>
            </>
          )}
          {active === "signup" && (
            <>
              <HeaderContainer>
                <HeaderText>Skapa </HeaderText>
                <HeaderText>Konto</HeaderText>
              </HeaderContainer>
              <SmallText>Logga in för att fortsätta!</SmallText>
            </>
          )}
        </TopContainer>
        <InnerContainer>
